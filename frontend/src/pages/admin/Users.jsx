...
import { Users as UsersIcon, Search, Shield, Stethoscope, User, Calendar, Mail } from 'lucide-react'

const usersData = [
    { id: 1, name: 'Rahul Sharma', email: 'rahul@example.com', role: 'patient', status: 'active', joined: '2026-01-15' },
    { id: 2, name: 'Ananya Iyer', email: 'ananya@example.com', role: 'patient', status: 'active', joined: '2026-01-20' },
    { id: 3, name: 'Vikram Das', email: 'vikram@example.com', role: 'patient', status: 'inactive', joined: '2025-12-10' },
    { id: 4, name: 'Dr. Priya Patel', email: 'priya@hospital.com', role: 'doctor', status: 'active', joined: '2025-11-01' },
    { id: 5, name: 'Dr. Arun Mehta', email: 'arun@hospital.com', role: 'doctor', status: 'active', joined: '2025-11-15' },
    { id: 6, name: 'Admin User', email: 'admin@medikiosk.com', role: 'admin', status: 'active', joined: '2025-10-01' },
    { id: 7, name: 'Meera Joshi', email: 'meera@example.com', role: 'patient', status: 'active', joined: '2026-02-10' },
    { id: 8, name: 'Dr. Sunita Rao', email: 'sunita@hospital.com', role: 'doctor', status: 'inactive', joined: '2025-12-20' },
]
...
export default function Users() {
    ...
    const roleCounts = { all: usersData.length, patient: usersData.filter(u => u.role === 'patient').length, doctor: usersData.filter(u => u.role === 'doctor').length, admin: usersData.filter(u => u.role === 'admin').length }
                                    ...
                                    >
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className={`w-9 h-9 rounded-full bg-gradient-to-br ${roleColors[user.role]} flex items-center justify-center text-sm font-bold text-white`}>
                                                    {user.name.charAt(0)}
                                                </div>
